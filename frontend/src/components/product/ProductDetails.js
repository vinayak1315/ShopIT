                ...
                <Fragment>
                    ...
                    <div className="row f-flex justify-content-around">
                        ...
                        <div className="col-12 col-lg-5 mt-5">
                            ...
                            <button type="button" id="cart_btn" className="btn btn-primary d-inline ml-4" disable={product.stock ===0} onClick={addToCart}>Add to Cart</button>
                            ...
                            {user ? <button id="review_btn" type="button" className="btn btn-primary mt-4" data-toggle="modal" data-target="#ratingModal" onClick={setUserRatings}>
                                Submit Your Review
                                    ...
                                    <div className="alert-danger mt-5 p-3" type="alert" >Login to post your review</div>
                            }
